  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-2 md:px-8 lg:px-10">
        <h2 className="font-OnlinePrivileges px-7 text-2xl md:text-4xl mb-4 text-white max-w-4xl">
          My journey 
        </h2>
        <p className="text-gray-400 px-7 text-sm md:text-base max-w-sm">
        ...
        content: (
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <ImageZoom
                src="https://pub-d02e3aa7d09f4d5d9261e5d7e4bae228.r2.dev/class.png"
                alt="class"
                width={500}
                height={500}
              ...
              />
              <ImageZoom
                src="https://pub-d02e3aa7d09f4d5d9261e5d7e4bae228.r2.dev/canteen.jpg"
                alt="canteen"
                width={500}
                height={500}
                className="rounded-lg object-cover w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] h-20 md:h-44 lg:h-auto lg:aspect-[16/9]"
              />
              <ImageZoom
                src="https://pub-d02e3aa7d09f4d5d9261e5d7e4bae228.r2.dev/holi.jpg"
                alt="holi"
                width={500}
                height={500}
                className="rounded-lg object-cover w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] h-20 md:h-44 lg:h-auto lg:aspect-[16/9]"
              />
              <ImageZoom
                src="https://pub-d02e3aa7d09f4d5d9261e5d7e4bae228.r2.dev/madvi%20gautam.png"
                alt="madhavi"
                width={500}
                height={500}
                className="rounded-lg object-cover w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] h-20 md:h-44 lg:h-auto lg:aspect-[16/9]"
      ...
      },
       {
        ...
        content: (
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <ImageZoom
                src="https://pub-d02e3aa7d09f4d5d9261e5d7e4bae228.r2.dev/knhs.jfif"
                alt="ashish_c"
                width={500}
                height={500}
                className="rounded-lg object-cover w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] h-20 md:h-44 lg:h-auto lg:aspect-[16/9]"
